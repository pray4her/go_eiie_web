...
interface ResumeProcessPaginationProps {
  page: number;
  totalPages: number;
  pageSize: number;
...
export function ResumeProcessPagination({ page, totalPages, pageSize, onPageChange, onPageSizeChange }: ResumeProcessPaginationProps) {
